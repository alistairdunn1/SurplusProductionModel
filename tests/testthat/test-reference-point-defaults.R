...
test_that("explicit arguments override package defaults", {
  ...
  expect_equal(ref_points$target_reference_points$baseline, "B0")
  expect_equal(ref_points$target_reference_points$biomass_name, "B_35%B0")
  expect_equal(ref_points$target_reference_points$f_name, "F_35%B0")
