...
#' parameters when no priors were supplied to the fitter.
...
#' supply \code{options$priors} to \code{fit_pella_tomlinson_model}; those
#' prior contributions remain in the objective used for sampling.
#'
